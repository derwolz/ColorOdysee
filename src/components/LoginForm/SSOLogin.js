...
//     console.log(inputs);
//     try {
//       const response = await baseApi.post("LoginForm/", inputs);
...
//         <SubmitButtonWrapper>
//           <a href="https://api.ColorOdysee.com/accounts/google/?process=login">
//             <button onClick={handleGmailAuth} >Gmail</button>
//           </a>
//         </SubmitButtonWrapper>
        
//         <SubmitButtonWrapper>
//         <button onClick={handleInstaAuth}>Instagram</button>
//         </SubmitButtonWrapper>
//         <SubmitButtonWrapper>
